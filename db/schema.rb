...
ActiveRecord::Schema.define(version: 2021_07_06_075716) do
  ...
  create_table "haisous", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["record_id"], name: "index_haisous_on_record_id"
  end
  ...
  add_foreign_key "haisous", "records"
